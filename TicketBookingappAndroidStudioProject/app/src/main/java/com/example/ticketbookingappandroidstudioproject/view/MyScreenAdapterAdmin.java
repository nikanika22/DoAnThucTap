...
public class MyScreenAdapterAdmin extends ArrayAdapter<Screen> {
    Activity context;
    int resource;
    List<Screen> DSScreen;

    public MyScreenAdapterAdmin(Activity context, int resource, List<Screen> DSScreen) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        txtFormat.setText(screen.getFormat() + " : " + screen.getRowCount() + " x " + screen.getColCount());
